	...
	<div class="main">
		<div class="welcome">
			...
			<a id="welcome_button" href="login.jsp"><button
					class="welcome_button">Login</button></a> <a id="welcome_button"
				href="./index.jsp">Need more clarity ?</a>
		</div>
		<div class="sign_up">
			<h1>Register here !!</h1>
			<form action="./Registration" method="post">
				<label for="fname"></label> <input type="text" name="fname"
					...
					autofocus required> <label for="lname"></label> <input
					...
					required>
				<div class="btm_btn">
					<input id="register" class="bottom_button" type="submit"
						value="Register">
				</div>
			</form>
		</div>
